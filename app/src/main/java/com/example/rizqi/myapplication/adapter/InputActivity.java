package com.example.rizqi.myapplication.adapter;
...
import com.example.rizqi.myapplication.BukuActivity;
...
public class InputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hotel = (Hotel) getIntent().getSerializableExtra(BukuActivity.HOTEL);
        if (hotel != null) {
    ...
    private void doSave() {
        ...
        if (isValid(judul, deskripsi, detail, lokasi, uriFoto)) {
            ...
            intent.putExtra(BukuActivity.HOTEL, hotel);
